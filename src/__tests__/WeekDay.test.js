...
test("Expect to get week day from week day number", () => {
  ...
  jest.setSystemTime(new Date("December 29, 2000 22:50:00")); // Friday
  expect(WeekDay.getCurrentWeekDay()).toBe("Friday");

  jest.setSystemTime(new Date("December 30, 2000 22:50:00")); // Saturday
  expect(WeekDay.getCurrentWeekDay()).toBe("Saturday");

  jest.setSystemTime(new Date("December 31, 2000 22:50:00")); // Sunday
  expect(WeekDay.getCurrentWeekDay()).toBe("Sunday");

  jest.setSystemTime(new Date("January 01, 2001 22:50:00")); // Monday
  expect(WeekDay.getCurrentWeekDay()).toBe("Monday");

  jest.setSystemTime(new Date("January 02, 2001 22:50:00")); // Tuesday
  expect(WeekDay.getCurrentWeekDay()).toBe("Tuesday");

  jest.setSystemTime(new Date("January 03, 2001 22:50:00")); // Wednesday
